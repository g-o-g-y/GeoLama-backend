"""
Django settings for GeoLama project.
...
WSGI_APPLICATION = 'GeoLama.wsgi.application'
...
REST_FRAMEWORK = {
    # Обработка ошибок
    'EXCEPTION_HANDLER': 'GeoLama.exceptions.core_exception_handler',
